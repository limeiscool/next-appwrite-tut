...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      />
      <button onClick={(buttonDisabled ? () => {} : onSignup)} className={(buttonDisabled ? "text-gray-600" : "text-white") + " p-2 border " + (buttonDisabled ? "border-gray-600" : "border-gray-300") + " rounded-lg mb-4 focus:ouline-none focus:border-gray-600"}>Signup 😎</button>
      <Toaster />
